...
class ProductRecommender(object):
    ...
    def __init__(self):
        ...
        self.P = None
#step = 5000
    def fit(self, user_x_product, latent_features_guess=2, learning_rate=0.0002, steps=500, regularization_penalty=0.02, convergeance_threshold=0.001):
        """
...
if __name__ == '__main__':
    ...
    for i in range(5):
        for a in resultCheck:
            if(a == getResult[i]):
                ids.append(resultCheck.index(a))
    print("index",ids)
